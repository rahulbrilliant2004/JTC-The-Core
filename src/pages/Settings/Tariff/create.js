...
import {getEntity, postEntity, postJsonEntity, putEntity, putFormDataEntity} from '../../../actions/entity';
...
class CreateForm extends Component {
  constructor(props) {
    super(props);
    this.state = {confirm: false, Component: this.getForm(), formdata: []};
  }
  ...
  updateEntity = () => {
    ...
    putEntity(entity + `/${id}`, newFormData).then((response) =>
