...
class CreateForm extends Component {
  ...
  componentDidMount() {
    ...
    this.props.edit && this.setState(
        ...
        () => {
          this.props.onUpdateForm('node_code', this.state.nodes);
          this.props.onUpdateForm('role_id', this.state.role_id);
         // this.props.onUpdateForm('passsword', this.state.passsword);
        },
      );
  }
  ...
  handleRowClick = (props) => {
    ...
    nodes.push(props);
    this.props.onUpdateForm('node_code', nodes.map((node) => node.node_id));
    this.setState({nodes});
  }
