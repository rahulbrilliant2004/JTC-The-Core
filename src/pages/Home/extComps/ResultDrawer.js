...
class ResultDrawer extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    let insurance = 0;
    if (adtSurcharge.includes('insurance')) {
          ...
          <GridList cols={2} cellHeight="auto">
              ...
              <GridList cols={2} cellHeight="auto">
                <GridListTile>
                  ...
                  <GridListTile>
                    ...
                    >
                      Rp {this.state.insurance ? (Math.floor((otherInfoReducer.insuredVal * 0.002) * 1000) / 1000) : 0}
                    </label>
                </GridListTile>
              </GridList>
            </GridListTile>
            ...
            <GridListTile cols={2}>
              <TotalResult
                ...
                otherInfoReducer={otherInfoReducer}
              />
              <Divider className={classes.nextDivider} />
            </GridListTile>
            <GridListTile cols={2}>
              <GrandTotalResult
                readOnly={readOnly}
