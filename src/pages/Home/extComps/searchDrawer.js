...
const Styles = (theme) => ({
  ...
  subdistrict_name: {color: '#000000', display: 'inline-block', width: '100%'},
  district_name: {color: '#9D0015', display: 'inline-block', width: '100%'},
  city_name: {color: '#7F7F7F', display: 'inline-block', width: '100%'},
});
      ...
      return (
        ...
        >
          <TableCell classes={{root: classes.placeTableCell}} padding="none">
            <span className={classes.subdistrict_name}>{subdistrict_name}</span>
            <span className={classes.district_name}>{district_name}</span>
            <span className={classes.city_name}>{city_name}</span>
          </TableCell>
